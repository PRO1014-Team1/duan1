<?php
[$pageno, $total_pages, $display_items] = pagination($_POST['pageno'] ?? 1, $_POST['search'] ?? "", get_customer());
...
<div class="container">
    ...
    <form action="" method="post" class="ta-center table-form">
        <table class="table table-striped mx-auto">
            ...
            <tbody>
                <?php foreach ($display_items as $customer) { ?>
                    <tr>
                            ...
                            <td class="ta-center extras">
                                <div class="wrapper">
                                    ...
                                    <div class="table__options_dropdown fadeIn ts-2 hidden">
                                        <ul class="flex">
                                            <li>
                                                <a href="edit-customer&username=<?= $customer['username'] ?>" class="btn btn--success">Sửa</a>
                                            </li>
                                            <li>
